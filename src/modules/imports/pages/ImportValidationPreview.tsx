...
export function ImportValidationPreview() {
  ...
  const hasRejected = (summary.rejected_rows || 0) > 0;
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex items-center">
          <div className="h-10 w-10 rounded-lg bg-gray-100 flex items-center justify-center mr-4">
            <span className="text-gray-600 font-semibold">{summary.total_rows || 0}</span>
          </div>
          <div>
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex items-center">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-gray-900">{summary.valid_rows || 0}</p>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex items-center">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-gray-900">{summary.warning_rows || 0}</p>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex items-center">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-gray-900">{summary.rejected_rows || 0}</p>
          </div>
        </div>
      </div>
              ...
              {rows.map((row: ImportRowResult) => {
                ...
                return (
                  <tr key={row.id} className={isRejected ? "bg-red-50/50" : ""}>
                    ...
                    <td className="px-4 py-3 text-gray-900">{row.raw_data["Student Full Name"] || "-"}</td>
                    <td className="px-4 py-3 text-gray-500">{row.raw_data["Admission Number"] || "-"}</td>
